...
# GENERAL VARIABLES
merged_fastq = "fastq_files_ori_{}.fof"
trimmed_fastq = "trimmed_fastq_files_{}.fof"
_CMD_FILE = "cmd_fastq_QC_{}.sh"
_PARALLEL_LOG = "fastq_QC_{}.log"
_OUTPUT_FOF = "raw_and_trimmed_fastqQC_{}.fof"
...
def cmd_fastqQC(config, merged_fof, trimmed_fof):
    ...
    for fastq in fof:
        ...
        # If files are raw merged, send output to merged QC directory
            ...
            cmd_str = "fastqc {}/{}/{} -o {} --extract".format(config["global_config"]["ori_fastq"], samplename.split('_')[0], samplename, config["paths"]["fastq_QC_raw"])
